...
using Telligent.Admin.Identity.Application.IoC;
using Telligent.Admin.Identity.Application.Localization;
using Telligent.Admin.Identity.Application.Swagger;
using Telligent.Admin.Identity.Database;
